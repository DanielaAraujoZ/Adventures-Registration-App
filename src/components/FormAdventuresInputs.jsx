...
export const FormAdventuresInputs = ({ data, selectedCharacter, setSelectedCharacter, query, setQuery }) => {
    return (
        <div className='flex flex-col'>
            <h4 className='info-item-gray text-lg leading-7 font-semibold my-3'>About Adventure</h4>
            ...
            <div className='flex items-center gap-5 ml-5 my-3'>
                ...
                <div className='flex flex-col gap-5'>
                    <label className='text-sm text-black' htmlFor="adventureOrigin">
                        Origin
                        <input type='text' name="adventure-origin" id='adventureOrigin' className='content-title h-12 form-input input-place rounded-lg mt-1' required/>
                    </label>
                    <label className='name-input text-sm' htmlFor="adventureDestination">
                        Destination
                        <input type='text' name='adventure-destination' id='adventureDestination' className='content-title form-input input-place text-base h-12 rounded-lg mt-1 focus:outline-none' required/>
                    </label>
                </div>
            </div>
            <h4 className='info-item-gray text-lg leading-7 font-semibold my-3'>Who is the Character</h4>
